...
| verClass | 是 | main类路径 | 运行脚本打印应用版本信息的入口类路径。<br/><br/>版本信息的配置依赖 [`构件经验库 exp-libs`](https://github.com/lyy289065406/exp-libs) 实现，详见 [这里](https://github.com/lyy289065406/exp-libs/tree/master/exp-libs/src/main/java/exp/libs/warp/ver) |
